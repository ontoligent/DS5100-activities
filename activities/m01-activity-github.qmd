...
1. **The Course Repo**, which is where you will find course materials, such as homework keys and exercises after the classes in which they are used. This should be [updated each day](../../topics/refreshing-the-course-repo.qmd).
