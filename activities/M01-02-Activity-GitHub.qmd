...
Go to [{{< var github_url >}}](%7B%7B%3C%20var%20github_url%20%3E%7D%7D) in your web browser.
...
``` bash
cd ~/Documents/MSDS/DS5100/{{< var course_code >}}/activities/hello 
```
...
1.  **The Course Repo**, which is where you will find course materials, such as homework keys and exercises after the classes in which they are used. This should be [updated each day](https://ontoligent.github.io/DS5100-book/topics/refreshing-the-course-repo.html).
