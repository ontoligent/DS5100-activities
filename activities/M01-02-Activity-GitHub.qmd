...
Go to [https://github.com/ontoligent/DS5100-activities](https://github.com/ontoligent/DS5100-activities) in your web browser.
...
``` bashco
git clone https://github.com:<github_user_name>/DS5100-activities.git
```
